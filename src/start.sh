...
if [ "$download_vace" == "true" ]; then
  ...
  download_model "https://huggingface.co/QuantStack/Wan2.1_14B_VACE-GGUF/resolve/main/Wan2.1_14B_VACE-Q6_K.gguf" "$DIFFUSION_MODELS_DIR/Wan2_1-VACE_module_14B_Q6_K.gguf"
